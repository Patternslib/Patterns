    ...
    describe("When a tooltip is clicked", function() {
        ...
        describe("if the 'source' parameter is 'ajax'", function() {
            ...
            it("will fetch its contents via ajax", async function() {
                ...
                const html = '<div id="content">External content fetched via an HTTP request.</div>';
                ...
                var $container = $el.data("patterns.tooltip.container");
                // Content is fetched from ./content.html#content
                expect($container.text()).toEqual(expect.stringContaining("External content fetched via an HTTP request."));
            });
        });
