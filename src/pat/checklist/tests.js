    ...
    describe("pat-checklist", function() {
        ...
        var utils = {
            createCheckList: function () {
                ...
                $fieldset.append($("<input type='checkbox' name='monkeys' checked='checked' />"));
                $fieldset.append($("<input type='checkbox' name='apes' checked='checked' />"));
                $fieldset.append($("<input type='checkbox' name='humans' checked='checked' />"));
                $fieldset.append($("<button class='select-all'>Select all</button>"));
