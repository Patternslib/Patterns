define(["pat-registry", "pat-navigation", "pat-inject"], function(Registry) {
    ...
    describe("Navigation pattern tests", function() {
        beforeEach(function() {
            ...
            nav2.setAttribute('data-pat-navigation', 'item-wrapper: div; in-path-class: in-path; current-class: active');
