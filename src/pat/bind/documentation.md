...
_pat-bind_ is built on the reactive primitives in [core/signals](../../core/signals.md) (Patternslib
helpers backed by the official TC39 Signals polyfill). The signals are an implementation detail - the page author only ever
writes markup.
